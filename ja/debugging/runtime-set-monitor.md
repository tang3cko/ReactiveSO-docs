---
layout: default
title: ランタイムセットモニター（Runtime Set Monitor）
parent: デバッグ
nav_order: 4
---
...
ランタイムセットの行をクリックすると、Projectウィンドウでアセットがping（ハイライト）されます。そこからアセットを選択して、Inspectorでその内容を確認できます。

### リアルタイムカウント

Count列は、オブジェクトがセットに登録・解除されるたびにPlay Mode中に自動更新されます。
